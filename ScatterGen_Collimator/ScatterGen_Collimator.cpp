...
int main(int argc, char* argv[])
{
	...
	string FnamePE;
	string FnameGeo = "GeometryRelationShip_Collimator2Crystal"; 
	int cuda_id = 0; 
	...
	for (int i = 1; i < argc; ++i)
	{
		...
		{
			cout << "Usage: " << argv[0] << " [-PE PE_SysMat_path] [-GeoCollimator GeometryRelationShip_Collimator2Crystal_path] [-cuda GPU_ID]" << endl;
			return 0;
		}
		else
		{
			cerr << "Unknown parameter or missing argument: " << argv[i] << endl;
			cout << "Usage: " << argv[0] << " [-PE PE_SysMat_path] [-GeoCollimator GeometryRelationShip_Collimator2Crystal_path]" << endl;
			return EXIT_FAILURE;
		}
	}
	...
	cout << "Geometry RelationShip Collimator2Crystal:  " << FnameGeo << endl;
	...
	for (int idxRotation = 0; idxRotation < numRotation; idxRotation++)
	{
		...
		int q = scatter(parameter_Collimator, parameter_Detector, parameter_Image, parameter_Physics, PE_SysMat, FnameGeo.c_str(), out + idxRotation * numProjectionSingle * numImagebin, cuda_id);
	...
	cout << "Time of io collimator scatter function: " << duration_scatter.count()/1000.0/60.0 << " min" << endl;
	...
	cout << "########################" << endl;
	cout << "Compton Scatter Sysmat of Collimator written." << endl;
	cout << "########################" << endl;
